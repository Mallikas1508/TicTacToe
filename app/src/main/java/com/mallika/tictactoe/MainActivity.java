...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.buttonImages1);
        button2 = findViewById(R.id.buttonImages2);
        button3 = findViewById(R.id.buttonImages3);
        button4 = findViewById(R.id.buttonImages4);
        button5 = findViewById(R.id.buttonImages5);
        button6 = findViewById(R.id.buttonImages6);
        button7 = findViewById(R.id.buttonImages7);
        button8 = findViewById(R.id.buttonImages8);
        button9 = findViewById(R.id.buttonImages9);
